...
MIDDLEWARE = [
    ...
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # Затем аутентификация
    'users.middleware.SuperuserOnlyAdminMiddleware',  # И только потом проверка суперпользователя
